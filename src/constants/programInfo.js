...
export const faq = {
  ...
  costOfLivingPrograms:
    "Software Engineering Immersive and Software Engineering Immersive - Remote", // leave as empty string is cost of living availability is the same across all programs
